...
import com.rivaldorendy.website.components.widgets.WorkExperienceBlock
import com.rivaldorendy.website.utils.Constants
import com.rivaldorendy.website.utils.Res
import com.rivaldorendy.website.utils.getAllWorkExperience
...
fun Experience() {
    Column(
        ...
        Span(
            ...
            SpanText(
                text = Constants.OF_WORK_EXPERIENCE
            )
        }
